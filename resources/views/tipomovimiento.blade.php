...
<div class="tipomovimiento">
    ...
    <form class="search-form" action="{{route('tipomovimiento.search')}}" method="GET">
        <label for="search">Buscar Tipo Movimiento:</label>
            <input type="text" id="search" autocomplete="off" name="search" placeholder="Ingrese la descripcion Tipo Movimiento">
    ...
    <form action="{{route('tipomovimiento.store')}}" method="POST">
        ...
        <input type="text" id="Descripcion" autocomplete="off" name="Descripcion" placeholder="Ingrese la descripcion del Tipo Movimiento">
